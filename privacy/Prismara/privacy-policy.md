...
Prismara ("the App") is a mobile hex-crystal puzzle game developed by JOTAD Labs ("we", "us", "our"). This privacy policy explains how we handle your data.
...
- **Game progress**: Levels completed, puzzles solved, zones unlocked
- **Settings**: Audio volume, language preference, accessibility options (colorblind mode, reduced motion)
- **Purchase records**: Whether you have purchased the Full Journey unlock or any hint packs (verified by the platform store)
- **Gameplay statistics**: Play time, sessions played, hints used
...
When you make an in-app purchase (Full Journey unlock or hint packs), the transaction is handled entirely by Google Play or Apple App Store. We do not collect or store your payment information. Please refer to:
- [Google Play Privacy Policy](https://policies.google.com/privacy)
- [Apple Privacy Policy](https://www.apple.com/legal/privacy/)

#### Advertising (Google AdMob)

The free version of Prismara displays ads provided by Google AdMob. AdMob may collect:
...
- **Full Journey upgrade**: Purchasing the Full Journey unlock removes all interstitial ads. Rewarded ads remain available but are always optional.
...
Prismara is rated for all ages (Everyone / 4+). We do not knowingly collect personal information from children under 13 (or the applicable age in your jurisdiction).
...
Privacy Policy: https://jotadlabs.github.io/privacy/prismara/
...
- This app contains in-app purchases (Full Journey unlock, hint packs)
...
*This privacy policy applies to Prismara version 1.0.0 and later.*
